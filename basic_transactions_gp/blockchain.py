...
def mine():
    ...
    if proof and user_id:
        validated_proof = blockchain.valid_proof(json.dumps(blockchain.last_block, sort_keys=True), proof)
        
        if validated_proof == False:
            response = {
                "message": "invalid proof",
                "valid": validated_proof,
                "last_block": blockchain.last_block
            }
        
            return jsonify(response), 400
        elif validated_proof == True:
        ...
        response = {
            'message': 'must send proof and user_id'
        }
        return jsonify(response), 400
